  ...
  "XgemmDirect", Precision::kSingle, {"KWID", "MDIMAD", "MDIMCD", "NDIMBD", "NDIMCD", "PADA", "PADB", "VWMD", "VWND", "WGD"}, {
    { // AMD GPUs
      kDeviceTypeGPU, "AMD", {
        ...
        { "Fiji", {
          { Name{"AMD Radeon (TM) R9 Fury Series                    "}, Params{ 2, 8, 8, 16, 16, 1, 1, 1, 1, 16, 0, 0, 0, 0, 0, 0 } },
    ...
    { // ARM GPUs
      kDeviceTypeGPU, "ARM", {
        { "default", {
          { Name{"Mali-G71                                          "}, Params{ 2, 16, 16, 32, 8, 1, 0, 1, 1, 32, 0, 0, 0, 0, 0, 0 } },
    ...
    { // Intel CPUs
      kDeviceTypeCPU, "Intel", {
        { "default", {
          ...
          { Name{"Intel(R) Core(TM) i7-6700K CPU @ 4.00GHz          "}, Params{ 8, 32, 16, 16, 16, 0, 0, 2, 2, 64, 0, 0, 0, 0, 0, 0 } },
    ...
    { // Intel GPUs
      kDeviceTypeGPU, "Intel", {
        { "default", {
          { Name{"Intel(R) Gen9 HD Graphics NEO                     "}, Params{ 8, 32, 32, 8, 8, 1, 0, 2, 8, 64, 0, 0, 0, 0, 0, 0 } },
          { Name{"Intel(R) HD Graphics 530 [0x1912]                 "}, Params{ 16, 8, 16, 16, 8, 1, 0, 4, 1, 64, 0, 0, 0, 0, 0, 0 } },
          ...
          { kDeviceNameDefault                                        , Params{ 2, 16, 16, 8, 8, 1, 1, 1, 2, 32, 0, 0, 0, 0, 0, 0 } },
        } },
      }
    },
    { // NVIDIA GPUs
